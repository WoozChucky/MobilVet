<%@ Page Title="Administração - Alterar Cliente" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ChangeClient.aspx.cs" Inherits="Admin_ChangeClient" %>
        ...
        <div class="col-md-8">
            <section id="loginForm">
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        <div class="col-md-offset-2 col-md-10">
                            <asp:Button ID="Button1" runat="server" OnClick="Back_Click" Text="Voltar" CssClass="btn btn-default" />
                        </div>
                    </div>
                </div>
            </section>
